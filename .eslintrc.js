module.exports = {
  ...
  rules: {
    ...
    'jsx-quotes': [2, 'prefer-single'],//字符串必须使用单引号
    ...
    'no-path-concat': 1,//node中可以使用__dirname或__filename做路径拼接
    'no-proto': 2,//禁止使用__proto__属性
    'no-redeclare': 2,//禁止重复声明变量
    'no-regex-spaces': 2,//禁止在正则表达式字面量中使用多个空格 /foo bar/
    'no-return-assign': [2, 'except-parens'],//return 语句中要有赋值表达式
    'no-self-assign': 2,
