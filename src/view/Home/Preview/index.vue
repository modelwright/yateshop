<template>
    <div class="pos wp100 bag1">
        <div class="pl40">
            <div class="f34 cor3 mt70 mb40 pt50">商品信息</div>
            <div class="heng vCenter pr30 bor_bb pb30">
                <div class="f28 cor3">{{Info.name}}</div>
                <div class="f20">¥<span class="f36">{{Info.price}}</span></div>
            </div>
        ...
        <div class="pl40 pr40">
            <div class="f34 cor3 mt70 pt50">优惠信息</div>
            <div class="heng vCenter pb35 pt35">
                <div class="f28 cor6">优惠券</div>
                <div class="cell__ft f28" @click="goCoupon">暂无优惠券</div>
            </div>
        </div>
        <div class="fixedboxh"></div>
        <div class="fixedbox heng vCenter">
            <div>
                <div class="f22 cor3 mb10">总计<span class="f36 cor3">￥{{Info.price}}</span></div>
...
.fixedbox{height:142px;.pl(40);.pr(40);background:#fff;}
.btns{.wh(210,80);font-size:28px;}
</style>
